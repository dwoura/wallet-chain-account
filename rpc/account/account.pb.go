...
func (x *CallContractRequest) GetChain() string {
	if x != nil {
		return x.Chain
	}
	return ""
...
const file_account_proto_rawDesc = "" +
	"\n" +
	"\raccount.proto\x12\x10dapplink.account\x1a\x15dapplink/common.proto\"\xbc\x02\n" +
	"\tTxMessage\x12\x12\n" +
	...
	"\bpagesize\x18\b \x01(\rR\bpagesize\"|\n" +
	...
	"\x10contract_address\x18\x06 \x01(\tR\x0fcontractAddress\x12\x12\n" +
	"\x04page\x18\a \x01(\rR\x04page\x12\x1a\n" +
	"\bpagesize\x18\b \x01(\rR\bpagesize\"\x89\x01\n" +
	"\x12NftAddressResponse\x12(\n" +
	"\x04code\x18\x01 \x01(\x0e2\x14.dapplink.ReturnCodeR\x04code\x12\x10\n" +
	"\x03msg\x18\x02 \x01(\tR\x03msg\x127\n" +
	"\bnft_info\x18\x03 \x03(\v2\x1c.dapplink.account.NftMessageR\anftInfo\"\x84\x03\n" +
	...
	"\x04page\x18\a \x01(\rR\x04page\x12\x1a\n" +
	"\bpagesize\x18\b \x01(\rR\bpagesize\"\xb1\x01\n" +
	"\x15NftCollectionResponse\x12(\n" +
	"\x04code\x18\x01 \x01(\x0e2\x14.dapplink.ReturnCodeR\x04code\x12\x10\n" +
	"\x03msg\x18\x02 \x01(\tR\x03msg\x12\\\n" +
	"\x16nft_collection_message\x18\x03 \x03(\v2&.dapplink.account.NftCollectionMessageR\x14nftCollectionMessage\"\x12\n" +
	...
	"\vgetTxByHash\x12\x1f.dapplink.account.TxHashRequest\x1a .dapplink.account.TxHashResponse\"\x00\x12s\n" +
	"\x16buildUnSignTransaction\x12*.dapplink.account.UnSignTransactionRequest\x1a+.dapplink.account.UnSignTransactionResponse\"\x00\x12s\n" +
	...
	"\fgetExtraData\x12\".dapplink.account.ExtraDataRequest\x1a#.dapplink.account.ExtraDataResponse\"\x00\x12b\n" +
	"\x13getNftListByAddress\x12#.dapplink.account.NftAddressRequest\x1a$.dapplink.account.NftAddressResponse\"\x00\x12e\n" +
	"\x10getNftCollection\x12&.dapplink.account.NftCollectionRequest\x1a'.dapplink.account.NftCollectionResponse\"\x00\x12Y\n" +
	"\fgetNftDetail\x12\".dapplink.account.NftDetailRequest\x1a#.dapplink.account.NftDetailResponse\"\x00\x12e\n" +
	...
	"\x19getAddressNftTradeHistory\x12/.dapplink.account.AddressNftTradeHistoryRequest\x1a0.dapplink.account.AddressNftTradeHistoryResponse\"\x00\x12_\n" +
	"\fcallContract\x12%.dapplink.account.CallContractRequest\x1a&.dapplink.account.CallContractResponse\"\x00B'\n" +
...
var file_account_proto_goTypes = []any{
	...
	(*CallContractRequest)(nil),            // 54: dapplink.account.CallContractRequest
	(*CallContractResponse)(nil),           // 55: dapplink.account.CallContractResponse
	(common.ReturnCode)(0),                 // 56: dapplink.ReturnCode
}
var file_account_proto_depIdxs = []int32{
	...
	56, // 2: dapplink.account.SupportChainsResponse.code:type_name -> dapplink.ReturnCode
	56, // 3: dapplink.account.ConvertAddressResponse.code:type_name -> dapplink.ReturnCode
	56, // 4: dapplink.account.ValidAddressResponse.code:type_name -> dapplink.ReturnCode
	56, // 5: dapplink.account.BlockResponse.code:type_name -> dapplink.ReturnCode
	13, // 6: dapplink.account.BlockResponse.transactions:type_name -> dapplink.account.BlockInfoTransactionList
	56, // 7: dapplink.account.BlockHeaderResponse.code:type_name -> dapplink.ReturnCode
	3,  // 8: dapplink.account.BlockHeaderResponse.block_header:type_name -> dapplink.account.BlockHeader
	56, // 9: dapplink.account.BlockByRangeResponse.code:type_name -> dapplink.ReturnCode
	3,  // 10: dapplink.account.BlockByRangeResponse.block_header:type_name -> dapplink.account.BlockHeader
	56, // 11: dapplink.account.AccountResponse.code:type_name -> dapplink.ReturnCode
	56, // 12: dapplink.account.FeeResponse.code:type_name -> dapplink.ReturnCode
	56, // 13: dapplink.account.SendTxResponse.code:type_name -> dapplink.ReturnCode
	56, // 14: dapplink.account.TxAddressResponse.code:type_name -> dapplink.ReturnCode
	1,  // 15: dapplink.account.TxAddressResponse.tx:type_name -> dapplink.account.TxMessage
	56, // 16: dapplink.account.TxHashResponse.code:type_name -> dapplink.ReturnCode
	1,  // 17: dapplink.account.TxHashResponse.tx:type_name -> dapplink.account.TxMessage
	56, // 18: dapplink.account.UnSignTransactionResponse.code:type_name -> dapplink.ReturnCode
	56, // 19: dapplink.account.SignedTransactionResponse.code:type_name -> dapplink.ReturnCode
	56, // 20: dapplink.account.VerifyTransactionResponse.code:type_name -> dapplink.ReturnCode
	56, // 21: dapplink.account.DecodeTransactionResponse.code:type_name -> dapplink.ReturnCode
	56, // 22: dapplink.account.ExtraDataResponse.code:type_name -> dapplink.ReturnCode
	56, // 23: dapplink.account.NftAddressResponse.code:type_name -> dapplink.ReturnCode
	40, // 24: dapplink.account.NftAddressResponse.nft_info:type_name -> dapplink.account.NftMessage
	56, // 25: dapplink.account.NftCollectionResponse.code:type_name -> dapplink.ReturnCode
	43, // 26: dapplink.account.NftCollectionResponse.nft_collection_message:type_name -> dapplink.account.NftCollectionMessage
	56, // 27: dapplink.account.CallContractResponse.code:type_name -> dapplink.ReturnCode
	5,  // 28: dapplink.account.WalletAccountService.getSupportChains:input_type -> dapplink.account.SupportChainsRequest
	7,  // 29: dapplink.account.WalletAccountService.convertAddress:input_type -> dapplink.account.ConvertAddressRequest
	9,  // 30: dapplink.account.WalletAccountService.validAddress:input_type -> dapplink.account.ValidAddressRequest
	11, // 31: dapplink.account.WalletAccountService.getBlockByNumber:input_type -> dapplink.account.BlockNumberRequest
	12, // 32: dapplink.account.WalletAccountService.getBlockByHash:input_type -> dapplink.account.BlockHashRequest
	15, // 33: dapplink.account.WalletAccountService.getBlockHeaderByHash:input_type -> dapplink.account.BlockHeaderHashRequest
	16, // 34: dapplink.account.WalletAccountService.getBlockHeaderByNumber:input_type -> dapplink.account.BlockHeaderNumberRequest
	18, // 35: dapplink.account.WalletAccountService.getBlockHeaderByRange:input_type -> dapplink.account.BlockByRangeRequest
	20, // 36: dapplink.account.WalletAccountService.getAccount:input_type -> dapplink.account.AccountRequest
	22, // 37: dapplink.account.WalletAccountService.getFee:input_type -> dapplink.account.FeeRequest
	24, // 38: dapplink.account.WalletAccountService.SendTx:input_type -> dapplink.account.SendTxRequest
	26, // 39: dapplink.account.WalletAccountService.getTxByAddress:input_type -> dapplink.account.TxAddressRequest
	28, // 40: dapplink.account.WalletAccountService.getTxByHash:input_type -> dapplink.account.TxHashRequest
	30, // 41: dapplink.account.WalletAccountService.buildUnSignTransaction:input_type -> dapplink.account.UnSignTransactionRequest
	32, // 42: dapplink.account.WalletAccountService.buildSignedTransaction:input_type -> dapplink.account.SignedTransactionRequest
	36, // 43: dapplink.account.WalletAccountService.decodeTransaction:input_type -> dapplink.account.DecodeTransactionRequest
	34, // 44: dapplink.account.WalletAccountService.verifySignedTransaction:input_type -> dapplink.account.VerifyTransactionRequest
	38, // 45: dapplink.account.WalletAccountService.getExtraData:input_type -> dapplink.account.ExtraDataRequest
	41, // 46: dapplink.account.WalletAccountService.getNftListByAddress:input_type -> dapplink.account.NftAddressRequest
	44, // 47: dapplink.account.WalletAccountService.getNftCollection:input_type -> dapplink.account.NftCollectionRequest
	46, // 48: dapplink.account.WalletAccountService.getNftDetail:input_type -> dapplink.account.NftDetailRequest
	48, // 49: dapplink.account.WalletAccountService.getNftHolderList:input_type -> dapplink.account.NftHolderListRequest
	50, // 50: dapplink.account.WalletAccountService.getNftTradeHistory:input_type -> dapplink.account.NftTradeHistoryRequest
	52, // 51: dapplink.account.WalletAccountService.getAddressNftTradeHistory:input_type -> dapplink.account.AddressNftTradeHistoryRequest
	54, // 52: dapplink.account.WalletAccountService.callContract:input_type -> dapplink.account.CallContractRequest
	6,  // 53: dapplink.account.WalletAccountService.getSupportChains:output_type -> dapplink.account.SupportChainsResponse
	8,  // 54: dapplink.account.WalletAccountService.convertAddress:output_type -> dapplink.account.ConvertAddressResponse
	10, // 55: dapplink.account.WalletAccountService.validAddress:output_type -> dapplink.account.ValidAddressResponse
	14, // 56: dapplink.account.WalletAccountService.getBlockByNumber:output_type -> dapplink.account.BlockResponse
	14, // 57: dapplink.account.WalletAccountService.getBlockByHash:output_type -> dapplink.account.BlockResponse
	17, // 58: dapplink.account.WalletAccountService.getBlockHeaderByHash:output_type -> dapplink.account.BlockHeaderResponse
	17, // 59: dapplink.account.WalletAccountService.getBlockHeaderByNumber:output_type -> dapplink.account.BlockHeaderResponse
	19, // 60: dapplink.account.WalletAccountService.getBlockHeaderByRange:output_type -> dapplink.account.BlockByRangeResponse
	21, // 61: dapplink.account.WalletAccountService.getAccount:output_type -> dapplink.account.AccountResponse
	23, // 62: dapplink.account.WalletAccountService.getFee:output_type -> dapplink.account.FeeResponse
	25, // 63: dapplink.account.WalletAccountService.SendTx:output_type -> dapplink.account.SendTxResponse
	27, // 64: dapplink.account.WalletAccountService.getTxByAddress:output_type -> dapplink.account.TxAddressResponse
	29, // 65: dapplink.account.WalletAccountService.getTxByHash:output_type -> dapplink.account.TxHashResponse
	31, // 66: dapplink.account.WalletAccountService.buildUnSignTransaction:output_type -> dapplink.account.UnSignTransactionResponse
	33, // 67: dapplink.account.WalletAccountService.buildSignedTransaction:output_type -> dapplink.account.SignedTransactionResponse
	37, // 68: dapplink.account.WalletAccountService.decodeTransaction:output_type -> dapplink.account.DecodeTransactionResponse
	35, // 69: dapplink.account.WalletAccountService.verifySignedTransaction:output_type -> dapplink.account.VerifyTransactionResponse
	39, // 70: dapplink.account.WalletAccountService.getExtraData:output_type -> dapplink.account.ExtraDataResponse
	42, // 71: dapplink.account.WalletAccountService.getNftListByAddress:output_type -> dapplink.account.NftAddressResponse
	45, // 72: dapplink.account.WalletAccountService.getNftCollection:output_type -> dapplink.account.NftCollectionResponse
	47, // 73: dapplink.account.WalletAccountService.getNftDetail:output_type -> dapplink.account.NftDetailResponse
	49, // 74: dapplink.account.WalletAccountService.getNftHolderList:output_type -> dapplink.account.NftHolderListResponse
	51, // 75: dapplink.account.WalletAccountService.getNftTradeHistory:output_type -> dapplink.account.NftTradeHistoryResponse
	53, // 76: dapplink.account.WalletAccountService.getAddressNftTradeHistory:output_type -> dapplink.account.AddressNftTradeHistoryResponse
	55, // 77: dapplink.account.WalletAccountService.callContract:output_type -> dapplink.account.CallContractResponse
